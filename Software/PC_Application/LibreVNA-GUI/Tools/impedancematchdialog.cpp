    ...
    ui(new Ui::ImpedanceMatchDialog)
{
    ...
    connect(ui->zGroup, &QButtonGroup::idClicked, this, &ImpedanceMatchDialog::calculateMatch);
    connect(ui->cMatchType, &QComboBox::currentIndexChanged, this, &ImpedanceMatchDialog::calculateMatch);
    connect(ui->lGroup, &QButtonGroup::idClicked, this, &ImpedanceMatchDialog::calculateMatch);
    connect(ui->cGroup, &QButtonGroup::idClicked, this, &ImpedanceMatchDialog::calculateMatch);
    connect(ui->zGroup, &QButtonGroup::idClicked, this, &ImpedanceMatchDialog::calculateMatch);
